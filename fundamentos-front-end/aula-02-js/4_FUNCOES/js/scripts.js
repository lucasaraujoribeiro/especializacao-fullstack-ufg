...
// 5 - arrow function
// Uma arrow function (função de seta) no JavaScript é uma forma mais concisa de escrever funções. 
//  Elas foram introduzidas no ECMAScript 6 (ES6) e oferecem uma sintaxe mais enxuta e algumas diferenças importantes em relação às funções tradicionais.
const testeArrow = () => {
